...
int main() {
    ...
    */
	printf("Enter a first numerator: ");
	scanf("%d",&num1);
	printf("Enter a first denumerator: ");
	scanf("%d",&den1);
	printf("Enter a second numerator: ");
	scanf("%d",&num2);
	printf("Enter a second denumerator: ");
	scanf("%d",&den2);
 
    printf("Addition for your numbers: ");
    fraction_add(num1, den1, num2, den2, &num3, &den3);
    fraction_print(num3, den3);
    printf("\n");

    printf("Subtraction for your numbers: ");
    fraction_sub(num1, den1, num2, den2, &num3, &den3);
    fraction_print(num3, den3);
    printf("\n");

    printf("Multiplication for your numbers: ");
    fraction_mul(num1, den1, num2, den2, &num3, &den3);
    fraction_print(num3, den3);
    printf("\n");

    printf("Division for your numbers: ");
    fraction_div(num1, den1, num2, den2, &num3, &den3);
    fraction_print(num3, den3);
    printf("\n");
    return(0);
